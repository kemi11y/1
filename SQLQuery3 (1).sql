...
CREATE DATABASE SHOP /* Створюємо БД SHOP */
GO

USE SHOP /* підключаємось до БД SHOP */

/* Створюємо таблицю SALES */
CREATE TABLE SALES( 
   ...
   /* Додаємо рядки даних до таблиць SALES*/
...
VALUES (43659, 11, '1753-01-01 00:00:00.000', '2011-06-12', '2011-06-07', 0, 29825,	279, 5,	184590.1346,	1971.5149,	616.0984,	'2011-06-07 00:00:00.000'),
	   ...
	   /*виводимо рядки таблиць  */
	   SELECT * FROM SALES;


	   /*
		видаляємо таблицю SALES ;
		*/
	   DROP TABLE SALES;


	   USE master; /* Звільняємо БД підключаючись до іншої.*/
 /*
видаляємо БД SHOP ;
*/
	   DROP DATABASE SHOP
